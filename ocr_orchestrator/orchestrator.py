...
def process_image(file, target_language): 
    try: 
        ...
        if detection_result: 
            ...
            replacement_payload = {'image_path': new_image_path, 'translated_text': translated_text, 'bounding_boxes': bounding_boxes} 
            ...
            #print('Replaced Image Path:', replaced_image_path)
